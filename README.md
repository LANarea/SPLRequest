...
<sub><sup>Might be subject to the "Max Search Results"-setting under the "Communications" tab.</sup></sub>
```
...
<sub><sup>Tip: Surround all your queries with the wildcard operator, eg. "*Elvis*"</sup></sub>
```
